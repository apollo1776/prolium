...
export const platformApi = {
    ...
    disconnectPlatform: (platform: string) => apiClient.delete(`/platforms/${platform}/disconnect`),
    refreshPlatform: (platform: string) => apiClient.post(`/platforms/${platform}/refresh`),
    getSyncStatus: (platform: string) => apiClient.get(`/platforms/${platform}/sync-status`),
};
