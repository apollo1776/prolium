...
export class PreferencesService {
  ...
  static async getNotificationPreferences(userId: string): Promise<NotificationPreferences> {
    ...
    return prefs.notificationPreferences as NotificationPreferences;
  }
  ...
  static async updateNotificationPreferences(
    ...
    await prisma.userPreferences.upsert({
      ...
      create: {
        userId,
        notificationPreferences: updated,
        appearancePreferences: await this.getAppearancePreferences(userId),
      },
    });
  ...
  static async getAppearancePreferences(userId: string): Promise<AppearancePreferences> {
    ...
    return prefs.appearancePreferences as AppearancePreferences;
  }
  ...
  static async updateAppearancePreferences(
    ...
    await prisma.userPreferences.upsert({
      where: { userId },
      update: {
        appearancePreferences: updated,
      },
      create: {
        userId,
        notificationPreferences: await this.getNotificationPreferences(userId),
        appearancePreferences: updated,
      },
    });
